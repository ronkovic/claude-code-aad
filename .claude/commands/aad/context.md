...
推奨アクション:
  ⚠️  大きなタスクは新セッションで開始することを推奨
  ⚠️  70%に達する前に区切りの良いタイミングで /aad:handoff を検討
  ✅ 小〜中規模のタスクは継続可能
...
推奨アクション:
  🔔 /aad:handoff の実行を強く推奨します
  🔔 現在のタスクを完了したら、新セッションで継続してください
...
推奨アクション:
  🚨 即座に /aad:handoff を実行してください！
  🚨 95%を超えると自動圧縮が始まり、制御が困難になります
  🚨 新しい作業は一切開始しないでください
