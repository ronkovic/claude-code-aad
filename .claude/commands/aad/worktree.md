...
解。これは変更内容を記録する行為。ゲームにおけるセーブポイントに相当します。

2️⃣ レビュー依頼を出す

gh pr create --draft --title "[タスクID]: [タスク名]"

告。これによりレビュアーへの通知が行われます。「宿題できました。確認お願いします」に相当。

3️⃣ 元のターミナルに戻って報告

/aad:status

提案。進捗確認後、次タスクへの移行を推奨します。

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

### 説明スタイル
- **解。** - 行為の意味を説明（「これは〇〇する行為」）
- **告。** - 通知・報告の説明（「これにより〇〇が行われます」）
- **提案。** - 次のアクションを推奨（「〇〇を推奨します」）
